...
const FEATURES: {
  ...
  {
    index: "02",
    eyebrow: "Active Compatibility",
    title: "Understand how your actives fit.",
    body: "Pore checks supported active categories to flag major conflicts, unnecessary overlap, and combinations that may be too irritating together.",
    tone: "lavender",
  ...
  },
  {
    ...
    body: "Log your routine and review standardized photos and self-reports as directional progress, without overstating what caused a change.",
    tone: "cream",
    visual: <ProgressMock />,
  },
  {
